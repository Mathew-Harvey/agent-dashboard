---
id: 3
title: Research ClawHub skill marketplace gaps — find underserved niches where we could build and publish a paid or popular skill. Document opportunities in memory/product-ideas/
status: review
priority: high
...
**ClawHub Research Complete (2026-02-16):**

Top skills by downloads:
1. ATXP (23k) - Web search, AI media
2. Gog (23k) - Google Workspace
3. Self-improving-agent (22k) - Learning
4. Wacli (20k) - WhatsApp
5. Tavily Search (19k) - Web search

**Gaps Identified:**
- No marine/boat-specific skills
- No Australian services (banks, utilities)
- No pet/home swap marketplace skills
- No small business automation bundles
- No unified email (AgentMail integration missing)
- No freelance/Upwork automation
